        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                   <form action="update" method="post">
                       @csrf
                       <input type="text" hidden name="photoID" value="{{ $photo->id }}">
                        <div class="form-group">
                            <label for="">Title</label>
                            <input type="text" class="form-control" name="title" id="" value="{{ $photo->title }}" aria-describedby="helpId" placeholder="">
                          </div>
                          <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="tag" id="tag" hidden value="">
                              @foreach ($tags as $p)
                              @if ($p->isCheck)
                              <input type="checkbox" name="checkBox" checked class="checkBox" value="{{ $p->id }}" id="">{{ $p->name }} <br>
                              @else
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $description->content }}" name="content" id="" aria-describedby="helpId" placeholder="">
                        </div>
